...
var params = {'token' : getGlobalToken()};
...
$(document).ready(function() {
  ...
  $(window).load(function() {
    ...
    insertResponseMessage('Please input your information!');
  });
  ...
  function callChatbotApi(message) {
    ...
    return sdk.lexPost(params, body, additionalParams)
    .then(function(result){
      var reply = result['data']['message'];
      insertResponseMessage(reply);
      if(reply == "Your infomation has been successsfully saved!"){
  ...
  function insertResponseMessage(content) {
    ...
    setTimeout(function() {
      ...
      //https://food.unl.edu/food-reflections/images/bell-peppers.png
      $('<div class="message new"><figure class="avatar"><img src="https://food.unl.edu/food-reflections/images/bell-peppers.png" /></figure>' + content + '</div>').appendTo($('.mCSB_container')).addClass('new');
      setDate();
      updateScrollbar();
      i++;
    }, 500);
